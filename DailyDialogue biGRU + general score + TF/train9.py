...
from vocabulary9 import SOS_token, batch2TrainData
from decoder9 import maskNLLLoss
import decoder9
from vocabulary9 import device, pairs, corpus_name, voc, save_dir, normalizeString, indexesFromSentence, MAX_LENGTH
import encoder9
...
#     '/Users/rajnu/Documents/Generative Chatbots BA/DailyDialogue biGRU + dot score + TF'
...
encoder = encoder9.EncoderRNN(hidden_size, embedding, encoder_n_layers, dropout)
decoder = decoder9.LuongAttnDecoderRNN(attn_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
