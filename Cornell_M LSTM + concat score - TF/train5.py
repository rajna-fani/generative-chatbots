...
from vocabulary5 import SOS_token, batch2TrainData
from decoder5 import maskNLLLoss
import decoder5
from vocabulary5 import device, pairs, corpus_name, voc, save_dir, normalizeString, indexesFromSentence, MAX_LENGTH
import encoder5
...
#     '/Users/rajnu/Documents/Generative Chatbots BA/Cornell_M transformer architecture LSTM +dot score + TF'
...
encoder = encoder5.EncoderRNN(hidden_size, embedding, encoder_n_layers, dropout)
decoder = decoder5.LuongAttnDecoderRNN(attn_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
