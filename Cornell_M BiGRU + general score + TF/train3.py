...
from vocabulary3 import SOS_token, batch2TrainData
from decoder3 import maskNLLLoss
import decoder3
from vocabulary3 import device, pairs, corpus_name, voc, save_dir, normalizeString, indexesFromSentence, MAX_LENGTH
import encoder3
...
encoder = encoder3.EncoderRNN(hidden_size, embedding, encoder_n_layers, dropout)
decoder = decoder3.LuongAttnDecoderRNN(attn_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
