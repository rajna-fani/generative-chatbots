...
from vocabulary10 import SOS_token, batch2TrainData
from decoder10 import maskNLLLoss
import decoder10
from vocabulary10 import device, pairs, corpus_name, voc, save_dir, normalizeString, indexesFromSentence, MAX_LENGTH
import encoder10
...
encoder = encoder10.EncoderRNN(hidden_size, embedding, encoder_n_layers, dropout)
decoder = decoder10.LuongAttnDecoderRNN(attn_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
