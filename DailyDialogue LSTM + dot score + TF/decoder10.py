...
import attention10
from vocabulary10 import device
...
2) Forward through unindirectional LSTM
...
class LuongAttnDecoderRNN(nn.Module):
    def __init__(self, attn_model, embedding, hidden_size, output_size, n_layers=1, dropout=0.1):
        ...
        self.attn = attention10.Attn(attn_model, hidden_size)

    '''
    INPUT:
    input_step: one word of input sequence batch
    las_hidden: final hidden layer of LSTM
    ...
    hidden: final hidden state of LSTM
    '''
