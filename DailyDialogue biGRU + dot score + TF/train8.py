...
from vocabulary8 import SOS_token, batch2TrainData
from decoder8 import maskNLLLoss
import decoder8
from vocabulary8 import device, pairs, corpus_name, voc, save_dir, normalizeString, indexesFromSentence, MAX_LENGTH
import encoder8
...
encoder = encoder8.EncoderRNN(hidden_size, embedding, encoder_n_layers, dropout)
decoder = decoder8.LuongAttnDecoderRNN(attn_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
