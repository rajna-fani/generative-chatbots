...
from vocabulary4 import SOS_token, batch2TrainData
from decoder4 import maskNLLLoss
import decoder4
from vocabulary4 import device, pairs, corpus_name, voc, save_dir, normalizeString, indexesFromSentence, MAX_LENGTH
import encoder4
...
encoder = encoder4.EncoderRNN(hidden_size, embedding, encoder_n_layers, dropout)
decoder = decoder4.LuongAttnDecoderRNN(attn_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
