...
from vocabulary2 import SOS_token, batch2TrainData
from decoder2 import maskNLLLoss
import decoder2
from vocabulary2 import device, pairs, corpus_name, voc, save_dir, normalizeString, indexesFromSentence, MAX_LENGTH
import encoder2
...
encoder = encoder2.EncoderRNN(hidden_size, embedding, encoder_n_layers, dropout)
decoder = decoder2.LuongAttnDecoderRNN(attn_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
...
clip = 50.0
# the model doesn't apply teacher forcing
